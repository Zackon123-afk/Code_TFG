...
with open("results_analisis_4_clusters_0.txt","w") as f:
    sys.stdout = f
...
with open("results_analisis_4_clusters_1.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_4_clusters_2.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_4_clusters_3.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
