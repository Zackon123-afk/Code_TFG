...
with open("results_analisis_6_clusters_0.txt","w") as f:
    sys.stdout = f
...
with open("results_analisis_6_clusters_1.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_6_clusters_2.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_6_clusters_3.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_6_clusters_4.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
...
with open("results_analisis_6_clusters_5.txt","w") as f:
    sys.stdout = f
    print(tweet_results.describe(include='all'))
